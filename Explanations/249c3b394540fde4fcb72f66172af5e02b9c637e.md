CI detected that the dependency upgrade from version **snakeyaml-1.17** to **snakeyaml-1.31** has failed. Here are details to help you understand and fix the problem:
