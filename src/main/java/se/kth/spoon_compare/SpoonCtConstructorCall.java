...
public class SpoonCtConstructorCall {
    ...
    private boolean constructorRemoved() {
        ...
        if (invocationSignature.equals(apiReference)) {
            System.out.print(invocationSignature);
            System.out.print(" api:  " + apiReference);
            System.out.println("  " + invocationSignature.equals(apiReference));
        }
