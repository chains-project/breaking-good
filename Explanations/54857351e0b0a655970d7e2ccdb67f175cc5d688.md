CI detected that the dependency upgrade from version **zip4j-1.3.2** to **zip4j-2.10.0** has failed. Here are details to help you understand and fix the problem:
