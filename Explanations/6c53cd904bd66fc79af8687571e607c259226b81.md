CI detected that the dependency upgrade from version **struts2-core-2.3.37** to **struts2-core-2.5.26** has failed. Here are details to help you understand and fix the problem:
