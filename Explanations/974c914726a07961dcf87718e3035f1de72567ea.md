CI detected that the dependency upgrade from version **asto-v1.8.0** to **asto-v1.10.0** has failed. Here are details to help you understand and fix the problem: 
